	...
	<body>
		<div id="wrapper">
			...
			<fieldset>
				...
				<form id="results_form" action="" method="" enctype="application/x-www-form-urlencoded">
					<p><label for="md5">md5:</label><input name="md5" id="md5" type="text" value="<?php if (!empty($source)) {echo md5($source);} ?>" maxlength="255" size="80" /></p>
					<p><label for="crypt">crypt:</label><input name="crypt" id="crypt" type="text" value="<?php if (!empty($source)) {echo crypt($source);} ?>" maxlength="255" size="80" /></p>
					<p><label for="crc32">crc32:</label><input name="crc32" id="crc32" type="text" value="<?php if (!empty($source)) {echo crc32($source);} ?>" maxlength="255" size="80" /></p>
					<p><label for="sha1">sha1:</label><input name="sha1" id="sha1" type="text" value="<?php if (!empty($source)) {echo sha1($source);} ?>" maxlength="255" size="80" /></p>
					<p><label for="base64">base64:</label><input name="base64" id="base64" type="text" value="<?php if (!empty($source)) {echo base64_encode($source);} ?>" maxlength="255" size="80" /></p>
					<p><label for="urlencode">urlencode:</label><input name="urlencode" id="urlencode" type="text" value="<?php if (!empty($source)) {echo htmlspecialchars(urlencode($source));} ?>" maxlength="255" size="80" /></p>
					<p><label for="urldecode">urldecode:</label><input name="urldecode" id="urldecode" type="text" value="<?php if (!empty($source)) {echo htmlspecialchars(urldecode($source));} ?>" maxlength="255" size="80" /></p>
					<p><label for="typo">typo:</label><input name="typo" id="typo" type="text" value="<?php

						if (!empty($p4)) {echo $p4;}

						?>" maxlength="255" size="80" /></p>
					<p><label for="unix_filename">unix_filename:</label><input name="unix_filename" id="unix_filename" type="text" value="<?php

						if (!empty($p1)) {echo $p1;}

						?>" maxlength="255" size="80" /></p>
					<p><label for="htmlentities">htmlentities:</label><textarea name="htmlentities" id="htmlentities" cols="30" rows="3"><?php

						if (!empty($p)) {echo $p;}

						?></textarea></p>
					<p><label for="safe_numbers">safe_numbers:</label><input name="safe_numbers" id="safe_numbers" type="text" value="<?php

						if (!empty($p5)) {echo $p5;}

						?>" maxlength="255" size="80" /></p>
					<p><label for="safe_latin_chars">safe_latin_chars:</label><input name="safe_latin_chars" id="safe_latin_chars" type="text" value="<?php

						if (!empty($p6)) {echo $p6;}

						?>" maxlength="255" size="80" /></p>
					<p><label for="java_escape">java_escape:</label><textarea name="java_escape" id="java_escape" cols="30" rows="3"><?php
...
<td onclick="alert(&quot;\u2666&quot;)">alert("\u2666");</td>
			...
			<script><!--//--><![CDATA[//><!--
				var a=document.forms.results_form;a&&a.htmlentities.value&&a.htmlentities.select();
				//--><!]]></script>
		</div>
	</body>
</html>
